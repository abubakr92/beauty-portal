  ...
  return (
    <fieldset className={styles.identityCard}>
      ...
      <div className={styles.identityChoices}>
        ...
        <label><input checked={anonymous} name="identity" onChange={() => setAnonymous(true)} type="radio" value="anonymous" /><span><strong>Post anonymously</strong><small>Your profile name and photo will not be shown to other members on this discussion.</small></span></label>
      </div>
      {anonymous && <div className={styles.identityHeader}>
        <Image src="/sanctuary/anonymous-avatar.png" alt="" width={42} height={42} />
        <div><p>Your anonymous name:</p><h2>{handles[handleIndex]}</h2><p>This name remains with your discussion and replies. You&apos;ll be marked as the Original Poster.</p></div>
